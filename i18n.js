...
window.I18N = (function () {
  ...
  var DICT = {
    th: {
      ...
      s1_hint: 'เลือกได้ 2 วิธี — ปักขนาดจากแบบ (แม่นสุดสำหรับ C&I) หรือวาดบนแผนที่',
      f_width: 'กว้าง (ม.)', f_length: 'ยาว (ม.)', btn_rect: 'ปักขนาด →',
      s1_rect_hint: 'วางที่กลางแผนที่ ตามทิศ (azimuth) — จากแบบ as-built ไม่ต้อง digitize ภาพ',
      btn_draw: 'เริ่มวาดหลังคา', btn_finish: '✓ เสร็จ', btn_clear: 'ล้าง',
    ...
    en: {
      ...
      s1_hint: 'Two ways — enter dimensions from drawings (most accurate for C&I) or draw on the map',
      f_width: 'Width (m)', f_length: 'Length (m)', btn_rect: 'Place size →',
      s1_rect_hint: 'Placed at map center, along azimuth — from as-built drawings, no image digitizing',
      btn_draw: 'Start drawing', btn_finish: '✓ Done', btn_clear: 'Clear',
